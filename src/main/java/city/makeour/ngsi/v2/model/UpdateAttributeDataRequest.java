...
public class UpdateAttributeDataRequest {
  ...
  public UpdateAttributeDataRequest value(@jakarta.annotation.Nonnull Double value) {
  ...
  public UpdateAttributeDataRequest metadata(@jakarta.annotation.Nonnull Object metadata) {
